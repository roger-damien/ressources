...
/*		Rappel sur la Liste des classes Wrapper
	...
	Integer emballage6 = 23;//auto-boxing
	Integer emballage = Integer.valueOf(j);//Java Factory Methods // of , valueOf , getInstance
	//On nous éloigne de l'implémentation
	
	System.out.println("toString d'un objet Integer :" + emballage);
	//System.out.println("toString d'un objet Integer :" + emballage.toString() );
