...
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";_gsScope._gsDefine("easing.CustomEase",["easing.Ease"],function(m){var x=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,S=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,_=/[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,d=/[cLlsS]/g,v="CustomEase only accepts Cubic Bezier data.",D=function(e,t,i,n,s,o,a,r,h,u,c){var l,f=(e+i)/2,g=(t+n)/2,p=(i+s)/2,x=(n+o)/2,d=(s+a)/2,y=(o+r)/2,m=(f+p)/2,S=(g+x)/2,_=(p+d)/2,v=(x+y)/2,w=(m+_)/2,M=(S+v)/2,b=a-e,k=r-t,C=Math.abs((i-a)*k-(n-r)*b),z=Math.abs((s-a)*k-(o-r)*b);return u||(u=[{x:e,y:t},{x:a,y:r}],c=1),u.splice(c||u.length-1,0,{x:w,y:M}),h*(b*b+k*k)<(C+z)*(C+z)&&(l=u.length,D(e,t,f,g,m,S,w,M,h,u,c),D(w,M,_,v,d,y,a,r,h,u,c+1+(u.length-l))),u},n=function(e){var t=this.lookup[e*this.l|0]||this.lookup[this.l-1];return t.nx<e&&(t=t.n),t.y+(e-t.x)/t.cx*t.cy},s=function(e,t,i){this._calcEnd=!0,(this.id=e)&&(m.map[e]=this),this.getRatio=n,this.setData(t,i)},e=s.prototype=new m;return e.constructor=s,e.setData=function(e,t){var i,n,s,o,a,r,h,u,c,l,f=(e=e||"0,0,1,1").match(x),g=1,p=[];if(l=(t=t||{}).precision||1,this.data=e,this.lookup=[],this.points=p,this.fast=l<=1,(d.test(e)||-1!==e.indexOf("M")&&-1===e.indexOf("C"))&&(f=function(e){var t,i,n,s,o,a,r,h,u,c,l,f=(e+"").replace(_,function(e){var t=+e;return t<1e-4&&-1e-4<t?0:t}).match(S)||[],g=[],p=0,x=0,d=f.length,y=2;for(t=0;t<d;t++)if(u=s,isNaN(f[t])?o=(s=f[t].toUpperCase())!==f[t]:t--,i=+f[t+1],n=+f[t+2],o&&(i+=p,n+=x),t||(r=i,h=n),"M"===s)a&&a.length<8&&(g.length-=1,y=0),p=r=i,x=h=n,a=[i,n],y=2,g.push(a),t+=2,s="L";else if("C"===s)a||(a=[0,0]),a[y++]=i,a[y++]=n,o||(p=x=0),a[y++]=p+1*f[t+3],a[y++]=x+1*f[t+4],a[y++]=p+=1*f[t+5],a[y++]=x+=1*f[t+6],t+=6;else if("S"===s)a[y++]="C"===u||"S"===u?(c=p-a[y-4],l=x-a[y-3],a[y++]=p+c,x+l):(a[y++]=p,x),a[y++]=i,a[y++]=n,o||(p=x=0),a[y++]=p+=1*f[t+3],a[y++]=x+=1*f[t+4],t+=4;else{if("L"!==s&&"Z"!==s)throw v;"Z"===s&&(i=r,n=h,a.closed=!0),("L"===s||.5<Math.abs(p-i)||.5<Math.abs(x-n))&&(a[y++]=p+(i-p)/3,a[y++]=x+(n-x)/3,a[y++]=p+2*(i-p)/3,a[y++]=x+2*(n-x)/3,a[y++]=i,a[y++]=n,"L"===s&&(t+=2)),p=i,x=n}return g[0]}(e)),4===(i=f.length))f.unshift(0,0),f.push(1,1),i=8;else if((i-2)%6)throw v;for(0==+f[0]&&1==+f[i-2]||function(e,t,i){i||0===i||(i=Math.max(+e[e.length-1],+e[1]));var n,s=-1*+e[0],o=-i,a=e.length,r=1/(+e[a-2]+s),h=-t||(Math.abs(+e[a-1]-+e[1])<.01*(+e[a-2]-+e[0])?function(e){var t,i=e.length,n=999999999999;for(t=1;t<i;t+=6)+e[t]<n&&(n=+e[t]);return n}(e)+o:+e[a-1]+o);for(h=h?1/h:-r,n=0;n<a;n+=2)e[n]=(+e[n]+s)*r,e[n+1]=(+e[n+1]+o)*h}(f,t.height,t.originY),this.rawBezier=f,o=2;o<i;o+=6)n={x:+f[o-2],y:+f[o-1]},s={x:+f[o+4],y:+f[o+5]},p.push(n,s),D(n.x,n.y,+f[o],+f[o+1],+f[o+2],+f[o+3],s.x,s.y,1/(2e5*l),p,p.length-1);for(i=p.length,o=0;o<i;o++)h=p[o],u=p[o-1]||h,h.x>u.x||u.y!==h.y&&u.x===h.x||h===u?(u.cx=h.x-u.x,u.cy=h.y-u.y,u.n=h,u.nx=h.x,this.fast&&1<o&&2<Math.abs(u.cy/u.cx-p[o-2].cy/p[o-2].cx)&&(this.fast=!1),u.cx<g&&(u.cx?g=u.cx:(u.cx=.001,o===i-1&&(u.x-=.001,g=Math.min(g,.001),this.fast=!1)))):(p.splice(o--,1),i--);if(i=1/g+1|0,a=1/(this.l=i),h=p[r=0],this.fast){for(o=0;o<i;o++)c=o*a,h.nx<c&&(h=p[++r]),n=h.y+(c-h.x)/h.cx*h.cy,this.lookup[o]={x:c,cx:a,y:n,cy:0,nx:9},o&&(this.lookup[o-1].cy=n-this.lookup[o-1].y);this.lookup[i-1].cy=p[p.length-1].y-n}else{for(o=0;o<i;o++)h.nx<o*a&&(h=p[++r]),this.lookup[o]=h;r<p.length-1&&(this.lookup[o-1]=p[p.length-2])}return this._calcEnd=1!==p[p.length-1].y||0!==p[0].y,this},e.getRatio=n,e.getSVGData=function(e){return s.getSVGData(this,e)},s.create=function(e,t,i){return new s(e,t,i)},s.version="0.2.2",s.bezierToPoints=D,s.get=function(e){return m.map[e]},s.getSVGData=function(e,t){var i,n,s,o,a,r,h,u,c,l,f=1e3,g=(t=t||{}).width||100,p=t.height||100,x=t.x||0,d=(t.y||0)+p,y=t.path;if(t.invert&&(p=-p,d=0),(e=e.getRatio?e:m.map[e]||console.log("No ease found: ",e)).rawBezier){for(i=[],h=e.rawBezier.length,s=0;s<h;s+=2)i.push(((x+e.rawBezier[s]*g)*f|0)/f+","+((d+e.rawBezier[s+1]*-p)*f|0)/f);i[0]="M"+i[0],i[1]="C"+i[1]}else for(i=["M"+x+","+d],o=1/(h=Math.max(5,200*(t.precision||1))),u=5/(h+=2),c=((x+o*g)*f|0)/f,n=((l=((d+e.getRatio(o)*-p)*f|0)/f)-d)/(c-x),s=2;s<h;s++)a=((x+s*o*g)*f|0)/f,r=((d+e.getRatio(s*o)*-p)*f|0)/f,(Math.abs((r-l)/(a-c)-n)>u||s===h-1)&&(i.push(c+","+l),n=(r-l)/(a-c)),c=a,l=r;return y&&("string"==typeof y?document.querySelector(y):y).setAttribute("d",i.join(" ")),i.join(" ")},s},!0)}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(e){"use strict";var t=function(){return(_gsScope.GreenSockGlobals||_gsScope).CustomEase};"undefined"!=typeof module&&module.exports?(require("../TweenLite.js"),module.exports=t()):"function"==typeof define&&define.amd&&define(["TweenLite"],t)}();
function swipeUp(e){document.getElementById("mentions").style.top=0}function swipeDown(){document.getElementById("mentions").style.top="100%",document.getElementById("mentions-link").style.opacity=1}window.onload=function(){document.getElementById("mentions-link").onmouseover=function(){swipeUp(this),i.pauseAllTimeLines()},document.getElementById("mentions-back").onclick=function(){swipeDown(),i.resumeAllTimeLines()};var i={init:function(){this.cuePointsList={},this.timeLines={},this.ended=!1},setCurTime:function(e,t){var i=0;return this.has(this.cuePointsList,e)?(this.cuePointsList[e].push(t),i=this.cuePointsList[e][0]):this.cuePointsList[e]=[t],i+t},has:function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},addTimeLine:function(e,t){this.has(this.timeLines,e)?console.log("Le nom de la timeLine est déjà présent"):this.timeLines[e]=new TimelineLite({onComplete:this.completeTL,onCompleteParams:[{name:e,_this:this}],data:{nbLoop:0,maxLoop:t}})},isTimeLinePresent:function(e){return this.has(this.timeLines,e)},completeTL:function(e){switch(e.name){case"main":e._this.timeLines[e.name].data.nbLoop++,e._this.timeLines[e.name].data.nbLoop<e._this.timeLines[e.name].data.maxLoop&&e._this.timeLines[e.name].play(.2);break;case"lights":case"lights2":case"floating":e._this.timeLines[e.name].play(0)}},getDuration:function(e){return this.timeLines[e].duration()},getTotalDuration:function(e){return this.timeLines[e].totalDuration()},getTime:function(e){return this.timeLines[e].time()},getTotalTime:function(e){return this.timeLines[e].totalTime()},getEndTime:function(e){return this.timeLines[e].endTime()},getTotalProgress:function(e){return this.timeLines[e].totalProgress()},getAllcuePoints:function(){for(c in this.cuePointsList);},pauseAllTimeLines:function(){for(c in this.timeLines)this.timeLines[c].pause()},pauseTimeLine:function(e){this.timeLines[e].pause()},resumeAllTimeLines:function(){if(!this.ended)for(c in this.timeLines)this.timeLines[c].play()},testEnd:function(e){i.timeLines[e].data.nbLoop>=i.timeLines[e].data.maxLoop-1&&(i.pauseAllTimeLines(),i.ended=!0)},testLoop:function(e){i.timeLines[e].data.nbLoop++,i.timeLines[e].data.nbLoop<=1&&i.timeLines[e].play(.2)}};i.init(),i.addTimeLine("main",2),i.addTimeLine("lights",0),i.addTimeLine("floating",0);var e="#fbcd00",t="#fff";i.timeLines.lights.set(".cls-2",{fill:t},0).set(".cls-3",{fill:e},0).set(".cls-3",{fill:t},.5).set(".cls-2",{fill:e},.5).set(".cls-2",{fill:t},.7).set(".cls-3",{fill:e},.7).set(".cls-3",{fill:t},.8).set(".cls-2",{fill:e},.8),i.timeLines.floating.to("#pup",1,{y:-10,ease:Linear.easeNone},0).to("#pup",1,{y:0,ease:Linear.easeNone},1),i.timeLines.floating.pause();function s(e,t){var i=new TimelineLite;return i.to(e,.08,{rotation:t}),i.to(e,.08,{rotation:-t}),i.to(e,.08,{rotation:t}),i.to(e,.08,{rotation:-t}),i.to(e,.08,{rotation:t}),i.to(e,.08,{rotation:0}),i}function n(e,t){i.timeLines[e].play(t,!0)}i.timeLines.lights.pause();CustomEase.create("bounce","M0,0 C0.126,0.382 0.272,0.724 0.43,0.872 0.622,1.052 0.81,1.096 1,1"),CustomEase.create("xbounce","M0,0,C0,0,0.049,0.675,0.085,1.115,0.122,1.498,0.156,1.34,0.16,1.322,0.189,1.193,0.203,1.111,0.23,0.978,0.262,0.818,0.303,0.876,0.307,0.882,0.335,0.925,0.349,0.965,0.38,1.006,0.43,1.088,0.484,1.022,0.53,0.997,0.58,0.964,0.667,1.002,0.725,1.004,0.829,1.008,1,1,1,1"),i.timeLines.main.to("#mask",.2,{autoAlpha:0}).set("#logo",{scale:.75,y:40},i.setCurTime("screen0",0)).from("#ecran0",.3,{opacity:0},i.setCurTime("screen0",.2)).from("#logo",.5,{opacity:0,y:30},i.setCurTime("screen0",.2)).from("#ecran1",.3,{opacity:0},i.setCurTime("screen1",1)).to("#ecran0",.2,{backgroundColor:"#de2554"},i.setCurTime("screen1",0)).to("#logo",.4,{y:-42,x:-170,scale:.47},i.setCurTime("screen1",0)).to("#forme-logo",.4,{fill:"#fbcd00"},i.setCurTime("screen1",0)).from("#falllivebox",7,{y:-900,ease:Linear.easeIn},i.setCurTime("screen1",0)).from("#pup2",.5,{x:-330},i.setCurTime("screen1",0)).to("#pup2",.5,{x:-60,y:40},i.setCurTime("screen1",0)).to("#pup2",.5,{scale:.6,y:25,x:-90},i.setCurTime("screen1",2)).call(n,["floating",0],this,i.setCurTime("screen1",0)).from("#container",.2,{opacity:0},i.setCurTime("screen1",.3)).from("#cadre",.5,{opacity:0,y:-30},i.setCurTime("screen1",.3)).from("#promo",.3,{scale:0,ease:"xbounce"},i.setCurTime("screen1",.6)).call(n,["lights",0],this,i.setCurTime("screen1",0)).set("#mentions-link",{visibility:"visible"},i.setCurTime("screen1",1.5)).from("#CTA",.3,{opacity:0,y:20},i.setCurTime("screen1",1.5)).from("#footer",.3,{opacity:0,y:20},i.setCurTime("screen1",1.5)).from("#fallboite",7,{y:-900,ease:Linear.easeIn},i.setCurTime("screen2",6)).set("#ecran2",{backgroundColor:"#26828e"},i.setCurTime("screen2",0)).from("#ecran2",.3,{opacity:0},i.setCurTime("screen2",0)).to("#ecran1",.2,{opacity:0},i.setCurTime("screen2",0)).from(".frame2",.2,{opacity:0},i.setCurTime("screen2",0)).from("#ecran3",.3,{opacity:0},i.setCurTime("screen3",11)).call(function(e,t){i.timeLines[e].pause(t,!0)},["floating",0],this,i.setCurTime("screen3",0)).to("#ecran2",.2,{opacity:0},i.setCurTime("screen3",0)).to(".frame2",.3,{opacity:0},i.setCurTime("screen3",0)).to("#pup2",.5,{scale:.4,y:40,x:-100},i.setCurTime("screen3",0)).to("#cadre",.3,{scale:.85,y:-25,x:-135},i.setCurTime("screen3",0)).from("#fond",.2,{scaleX:1.5},i.setCurTime("screen3",0)).from("#orange",.2,{opacity:0},i.setCurTime("screen3",0)).to("#forme-logo",.4,{fill:"#de2554"},i.setCurTime("screen3",0)).to("#CTA",.1,{className:"+=invert"},i.setCurTime("screen3",0)).from("#livebox",.5,{scale:0,rotation:-60,ease:"xbounce"},i.setCurTime("screen3",.5)).from("#boite",.5,{scale:0,rotation:-60,ease:"xbounce"},i.setCurTime("screen3",.5)).from("#titre01",.5,{opacity:0,y:30,ease:"xbounce"},i.setCurTime("screen3",.2)).add(s("#boite",10),i.setCurTime("screen3",.8)).add(s("#livebox",10),i.setCurTime("screen3",1.2)).call(i.testEnd,["main"],this,i.setCurTime("screen3",4))};
/*!
 * VERSION: 1.17.0
 * DATE: 2015-05-27
 * UPDATES AND DOCS AT: http://greensock.com
